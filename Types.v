...
Example some_term_is_stuck :
  exists t, stuck t.
Proof.
  unfold stuck, step_normal_form, value, not. 
...
Proof.
  ...
  intros. inversion H.
  - inversion H0. 
    + inversion H1; rewrite <- H3 in H2; inversion H2.
  - induction H1. 
    + inversion H0. inversion H1.
    + assert (value t). right. assumption.
      * inversion H0. inversion H3. subst. apply IHnvalue in H2. 
      { apply H2. } 
...
Proof with auto.
  ...
  - (* T_Succ *)
    ...
    + left. right. constructor. 
      apply (nat_canonical t1 HT) in H. assumption.
  ...
  - (* T_Zero *)
    ...
    + right. induction H. exists (tiszero x). constructor. assumption.
Qed.
